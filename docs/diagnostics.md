...
`UniformMonitoring` is implemented beside the generator in [`src/clas12-uniform/`](../src/clas12-uniform/). There is no separate shared monitoring layer because physical conversion does not consume it.
