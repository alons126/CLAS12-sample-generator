# History, migration, and parity

These pages preserve development and reproducibility context. They are not required for ordinary operation.

The public baseline for the legacy code is the [`legacy-v1.0.0` GitHub release tag](https://github.com/alons126/CLAS12-sample-generator/releases/tag/legacy-v1.0.0). It records the archived `legacy/` tree and the pinned revision of the independent Uniform-sample-generator submodule used for comparison and parity validation.
