...
| --- | --- | --- |
| `uniform-integration` | 1e plus all proton/neutron/pip/pim FD/CD labels, seed repeat, tester, config overrides, invalid inputs | Output counts/PDGs, bounds, rounded-record mass-shell relation, unchanged repeat output and rejection semantics |
