...
The report fixtures originated from the working C-shell coordinator captured before its Python migration. The original migration comparison also verified Slurm arguments and configured exports. Current fixtures reflect the maintained Python report layout; the external worker script and detector resources remain unchanged.
