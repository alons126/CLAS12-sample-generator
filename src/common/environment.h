 ...
 */
namespace environment {
inline const std::string ERROR_COLOR = "\033[31m";       // Red
inline const std::string COMPLETION_COLOR = "\033[32m";  // Green
inline const std::string SYSTEM_COLOR = "\033[33m";      // Yellow
inline const std::string INFO_COLOR = "\033[35m";        // Magenta
